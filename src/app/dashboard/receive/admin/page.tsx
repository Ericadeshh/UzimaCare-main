...
import AdminReceivingDashboard from "@/components/receiving-facility/admin/AdminReceivingDashboard";
...
export default function ReceiveAdminPage() {
  ...
  useEffect(() => {
    const fixMissingHospital = async () => {
      ...
      try {
        ...
        if (!user.hospital) {
          const defaultHospital = `${user.name}'s Hospital`;
